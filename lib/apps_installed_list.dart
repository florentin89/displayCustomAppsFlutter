...
class AppsInstalledListScreen extends StatefulWidget {
  const AppsInstalledListScreen({super.key});

  @override
  State<AppsInstalledListScreen> createState() =>
      _AppsInstalledListScreenState();
}

class _AppsInstalledListScreenState extends State<AppsInstalledListScreen> {
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (String key) {
              ...
              if (key == 'launchable_apps') {
                setState(() => _onlyLaunchableApps = !_onlyLaunchableApps);
              }
            },
          )
        ],
      ),
      body: _AppsInstalledListScreenContent(
...
class _AppsInstalledListScreenContent extends StatelessWidget {
  final bool includeSystemApps;
  final bool onlyAppsWithLaunchIntent;

  const _AppsInstalledListScreenContent(
      {Key? key,
